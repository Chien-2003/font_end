      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-white">Elysia Wear</h3>
            <p className="text-sm text-gray-400 max-w-xs">
              Phong cách tối giản cho cuộc sống hiện đại. Mang đến những thiết
              kế tinh tế và chất lượng vượt trội.
            </p>
          ...
          <div>
            <h4 className="font-semibold text-white mb-4">Cửa Hàng</h4>
