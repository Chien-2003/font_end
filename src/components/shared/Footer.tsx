        ...
        <div className="flex flex-row w-full lg:w-[24%] md:w-[70%] justify-self-end md:justify-center items-center">
          <div className="relative z-0 my-5 w-full group">
            <input
              ...
              name="floating_email"
              id="floating_email"
              className="block py-2.5 px-0 pr-10 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 pl-2 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required
            />
            <label
