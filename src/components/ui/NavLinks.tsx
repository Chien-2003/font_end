      ...
      <ul className="flex gap-4">
        {links.map((link) => (
          <li key={link.name} className="relative group py-3">
            ...
            {link.submenu && (
              <ul className="absolute left-0 w-48 bg-white rounded shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-300 z-50">
