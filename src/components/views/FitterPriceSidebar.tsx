...
export default function AccordionSidebar() {
  return (
    <Sidebar>
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="mb-2 text-base font-semibold">
            Lọc sản phẩm
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <Accordion
                ...
                >
                  <AccordionPrimitive.Header className="flex">
                    <AccordionPrimitive.Trigger
                      className="focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center justify-between rounded-md py-2 text-left text-[15px] leading-6 font-semibold transition-all outline-none focus-visible:ring-[1px]
                    ...
                    >
                      ...
                      <PlusIcon
                        size={16}
                        className="shrink-0 opacity-60 transition-transform cursor-pointer duration-200"
                        aria-hidden="true"
                      />
                    </AccordionPrimitive.Trigger>
                  </AccordionPrimitive.Header>

                  <AccordionContent className="text-muted-foreground pb-2 ps-2">
                    {item.content}
                  </AccordionContent>
                </AccordionItem>
              ))}
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full border border-black rounded-full py-3 text-center font-semibold hover:bg-primary hover:text-white transition-colors dark:border-white dark:hover:border-primary hover:border-primary cursor-pointer"
              >
                Xoá
              </button>
            </div>
